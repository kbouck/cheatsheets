...
```
linux installer extracts to /tmp/, 
/Users/kbouck/Documents/work/SAG/Installer_UpdateMgr/Installer/sagInstaller_2019-04-15.jar 

/tmp/saginstaller.5023/jvm/bin/java -Djava.io.tmpdir=/tmp  -cp /tmp/saginstaller.5023/sagInstaller.jar com.wm.distman.install.DistManInstallMain 
...
```bash
installer lets you create a script without requiring that the license key be specified
```
